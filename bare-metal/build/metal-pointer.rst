...
Hexadecimal [24-Bits]
      ...
      001700                         69         .ds 256 
                                     ...
                                     75 ;**********************************************************
      008000 82 00 80 8F             76 	int cold_start	        ; reset
      008004 82 00 80 80             77 	int NonHandledInterrupt	; trap
      008008 82 00 80 80             78 	int NonHandledInterrupt	; irq0
      00800C 82 00 80 80             79 	int NonHandledInterrupt	; irq1
      008010 82 00 80 80             80 	int NonHandledInterrupt	; irq2
      008014 82 00 80 80             81 	int NonHandledInterrupt	; irq3
      008018 82 00 80 80             82 	int NonHandledInterrupt	; irq4
      00801C 82 00 80 80             83 	int NonHandledInterrupt	; irq5
      008020 82 00 80 80             84 	int NonHandledInterrupt	; irq6
      008024 82 00 80 80             85 	int NonHandledInterrupt	; irq7
      008028 82 00 80 80             86 	int NonHandledInterrupt	; irq8
      00802C 82 00 80 80             87 	int NonHandledInterrupt	; irq9
      008030 82 00 80 80             88 	int NonHandledInterrupt	; irq10
      008034 82 00 80 80             89 	int NonHandledInterrupt	; irq11
      008038 82 00 80 80             90 	int NonHandledInterrupt	; irq12
      00803C 82 00 80 80             91 	int NonHandledInterrupt	; irq13
      008040 82 00 80 80             92 	int NonHandledInterrupt	; irq14
      008044 82 00 80 80             93 	int NonHandledInterrupt	; irq15
      008048 82 00 80 80             94 	int NonHandledInterrupt	; irq16
      00804C 82 00 80 80             95 	int NonHandledInterrupt	; irq17
      008050 82 00 80 80             96 	int NonHandledInterrupt	; irq18
      008054 82 00 80 80             97 	int NonHandledInterrupt	; irq19
      008058 82 00 80 80             98 	int NonHandledInterrupt	; irq20
      00805C 82 00 80 80             99 	int NonHandledInterrupt	; irq21
      008060 82 00 80 80            100 	int NonHandledInterrupt	; irq22
      008064 82 00 80 81            101 	int Timer4Handler	    ; irq23
      008068 82 00 80 80            102 	int NonHandledInterrupt	; irq24
      00806C 82 00 80 80            103 	int NonHandledInterrupt	; irq25
      008070 82 00 80 80            104 	int NonHandledInterrupt	; irq26
      008074 82 00 80 80            105 	int NonHandledInterrupt	; irq27
      008078 82 00 80 80            106 	int NonHandledInterrupt	; irq28
      00807C 82 00 80 80            107 	int NonHandledInterrupt	; irq29
                                    108 
                                    109 ;**********************************************************
                                    110         .area CODE
                                    111 ;**********************************************************
      ...
      008080                        114 NonHandledInterrupt:
      008080 80               [11]  115         iret 
                                    116 ;        ld a, #0x80
                                    117 ;        ld WWDG_CR,a ; WWDG_CR used to reset mcu
                                    118 
                                    119 ; used for count down timer 
      008081                        120 Timer4Handler:
      008081 72 5F 53 42      [ 1]  121 	clr TIM4_SR 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 27.
Hexadecimal [24-Bits]



      008085 CE 00 04         [ 2]  122     ldw x,CNTDWN 
      008088 27 04            [ 1]  123     jreq 1$
      00808A 5A               [ 2]  124     decw x 
      00808B CF 00 04         [ 2]  125     ldw CNTDWN,x 
      00808E                        126 1$:     
      00808E 80               [11]  127     iret 
                                    128 
                                    129 
                                    130 ; entry point at power up 
                                    131 ; or reset 
      00808F                        132 cold_start: 
                                    133 
                                    134 ; initialize clock to HSE
                                    135 ; no divisor 12 Mhz crystal  
      00808F                        136 clock_init:
      00808F 72 5F 50 C6      [ 1]  137     clr CLK_CKDIVR
      008093 72 17 50 C5      [ 1]  138     bres CLK_SWCR,#CLK_SWCR_SWIF 
      008097 35 B4 50 C4      [ 1]  139     mov CLK_SWR,#CLK_SWR_HSE ; 12 Mhz crystal
      00809B 72 07 50 C5 FB   [ 2]  140     btjf CLK_SWCR,#CLK_SWCR_SWIF,. 
      0080A0 72 12 50 C5      [ 1]  141 	bset CLK_SWCR,#CLK_SWCR_SWEN
                                    142 ; initialize stack pointer 
      0080A4 AE 07 FF         [ 2]  143     ldw x,#RAM_SIZE-1 
      0080A7 94               [ 1]  144     ldw sp,x 
                                    145 ; clear all ram 
      0080A8 7F               [ 1]  146 1$: clr (x)
      ...
      0080B3 C7 50 CA         [ 1]  153     ld CLK_PCKENR2,a 
                                    ...
                                    155 ; to reduce noise 
      0080B6 A6 FF            [ 1]  156 	ld a,#255 
      0080B8 C7 50 03         [ 1]  157 	ld PA_CR1,a 
      0080BB C7 50 08         [ 1]  158 	ld PB_CR1,a
      0080BE C7 50 0D         [ 1]  159     ld PC_CR1,a  
      0080C1 C7 50 12         [ 1]  160 	ld PD_CR1,a 
      0080C4 C7 50 17         [ 1]  161 	ld PE_CR1,a 
      0080C7 C7 50 1C         [ 1]  162 	ld PF_CR1,a 
      0080CA C7 50 21         [ 1]  163 	ld PG_CR1,a 
                                    164 ; set PC4 as output low 
                                    165 ; this is TIM1_CH4 output 
                                    166 ; want it low when PWM is off     
      0080CD 72 18 50 0C      [ 1]  167     bset PC_DDR,#4 ; output mode 
      0080D1 72 19 50 0A      [ 1]  168     bres PC_ODR,#4 ; low 
                                    169 ; set alarm LED as output 
      0080D5 72 17 50 0D      [ 1]  170     bres ALARM_LED_CR1,#ALARM_LED_BIT ; open drain 
      0080D9 72 16 50 0C      [ 1]  171     bset ALRAM_LED_DDR,#ALARM_LED_BIT
      00005D                        172     _led_off 
      0080DD 72 16 50 0A      [ 1]    1     bset ALARM_LED_ODR,#ALARM_LED_BIT 
                           000001   173 .if DEBUG 
      0080E1 CD 82 29         [ 4]  174     call uart_init 
                                    175 .endif     
...
Hexadecimal [24-Bits]
      ...
      0080E4                        177 timer4_init: 
      0080E4 72 11 53 40      [ 1]  178 	bres TIM4_CR1,#TIM4_CR1_CEN 
      0080E8 35 06 53 45      [ 1]  179 	mov TIM4_PSCR,#6 ; prescale 64  
      0080EC 35 BB 53 46      [ 1]  180 	mov TIM4_ARR,#187 ; for 1msec. 12Mhz/64/1000 
      0080F0 72 10 53 41      [ 1]  181 	bset TIM4_IER,#TIM4_IER_UIE 
      0080F4 35 01 53 40      [ 1]  182 	mov TIM4_CR1,#(1<<TIM4_CR1_CEN);|(1<<TIM4_CR1_URS)
      0080F8 72 10 53 43      [ 1]  183     bset TIM4_EGR,#TIM4_EGR_UG 
      0080FC 9A               [ 1]  184     rim
                                    185 ; initialize TIMER2 for 1Khz tone generator 
      0080FD                        186 timer2_init:
      0080FD 72 19 50 12      [ 1]  187     bres PD_CR1,#4 ; open drain output 
      008101 35 60 53 05      [ 1]  188  	mov TIM2_CCMR1,#(6<<TIMx_CCRM1_OC1M) ; PWM mode 1 
      008105 35 06 53 0C      [ 1]  189 	mov TIM2_PSCR,#6 ; 12Mhz/64=187500
      008109 72 5F 53 0D      [ 1]  190     clr TIM2_ARRH 
      00810D 35 BB 53 0E      [ 1]  191     mov TIM2_ARRL,#187
      008111 72 5F 53 0F      [ 1]  192     clr TIM2_CCR1H
      008115 35 5E 53 10      [ 1]  193     mov TIM2_CCR1L,#94
                                    194 ; initialize TIMER1 for PWM generation 
                                    195 ; Fpwm= 50329 Hertz 
      008119 AE 00 ED         [ 2]  196     ldw x,#TMR1_PERIOD 
      00811C CF 00 06         [ 2]  197     ldw PERIOD,x 
      00811F 72 5F 52 60      [ 1]  198     clr TIM1_PSCRH
      008123 72 5F 52 61      [ 1]  199     clr TIM1_PSCRL 
      008127 72 5F 52 62      [ 1]  200     clr TIM1_ARRH 
      00812B 35 ED 52 63      [ 1]  201     mov TIM1_ARRL,#TMR1_PERIOD ; 12Mhz/50329=158.9
      00812F 72 5F 52 6B      [ 1]  202     clr TIM1_CCR4H
      008133 35 76 52 6C      [ 1]  203     mov TIM1_CCR4L,#TMR1_DC 
      008137 72 18 52 5D      [ 1]  204     bset TIM1_CCER2,#TIM_CCER2_CC4E 
      00813B 35 68 52 5B      [ 1]  205     mov TIM1_CCMR4,#(6<<4)|(1<<3) ;OC4M=6|OC4PE=1 ; PWM mode 1 
                                    206 ; enable counter 
      ...
      008153                        215 init_detector: 
                           ...
                           000001   219 .if DEBUG 
      008153 A6 1B            [ 1]  220     ld a,#27
      008155 CD 82 57         [ 4]  221     call uart_putc
      008158 A6 63            [ 1]  222     ld a,#'c 
      00815A CD 82 57         [ 4]  223     call uart_putc 
                                    224 .endif 
      00815D 4B 20            [ 1]  225     push #32
      00815F 5F               [ 1]  226     clrw x 
      008160 CF 00 00         [ 2]  227     ldw SAMPLES_SUM,x  
      008163                        228 2$: 
      008163 CD 81 D5         [ 4]  229     call sample 
      008166 72 BB 00 00      [ 2]  230     addw x, SAMPLES_SUM
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 29.
Hexadecimal [24-Bits]



      00816A CF 00 00         [ 2]  231     ldw SAMPLES_SUM, x
      00816D 0A 01            [ 1]  232     dec (1,sp)
      00816F 26 F2            [ 1]  233     jrne 2$
      008171 90 AE 00 20      [ 2]  234     ldw y,#32
      008175 65               [ 2]  235     divw x,y 
      008176 CF 00 02         [ 2]  236     ldw SAMPLES_MEAN,x 
                                    237 
                           000001   238 .if DEBUG 
      008179 CD 82 80         [ 4]  239     call uart_prt_int
      00817C A6 0D            [ 1]  240     ld a,#13
      00817E CD 82 57         [ 4]  241     call uart_putc
                                    242 .endif 
      008181 84               [ 1]  243     pop a 
                                    244 
                                    245 ; begin detection 
      008182                        246 detector:
      008182 CD 81 D5         [ 4]  247     call sample 
      008185 89               [ 2]  248     pushw x 
      008186 CE 00 02         [ 2]  249     ldw x,SAMPLES_MEAN 
      008189 72 F0 01         [ 2]  250     subw x,(1,sp)
      00818C 2A 01            [ 1]  251     jrpl 3$ 
      00818E 50               [ 2]  252     negw x  
      00818F A3 00 02         [ 2]  253 3$: cpw x,#SENSIVITY 
      008192 2B 06            [ 1]  254     jrmi 4$ 
                           000001   255 .if DEBUG 
      008194 CD 82 80         [ 4]  256 call uart_prt_int
                                    257 .endif 
      008197 CD 81 B2         [ 4]  258     call alarm 
      00819A                        259 4$: 
                                    260     ; adjust SAMPLES_MEAN 
      00819A CE 00 00         [ 2]  261     ldw x,SAMPLES_SUM  
      00819D 72 B0 00 02      [ 2]  262     subw x,SAMPLES_MEAN 
      0081A1 72 FB 01         [ 2]  263     addw x,(1,sp)
      0081A4 CF 00 00         [ 2]  264     ldw SAMPLES_SUM,x 
      0081A7 90 AE 00 20      [ 2]  265     ldw y,#32 
      0081AB 65               [ 2]  266     divw x,y 
      0081AC CF 00 02         [ 2]  267     ldw SAMPLES_MEAN,x 
      0081AF 85               [ 2]  268     popw x 
      0081B0 20 D0            [ 2]  269     jra detector 
                                    270 
                                    271 ;----------------------
                                    272 ; detection alarm 
                                    273 ;----------------------
      ...
      0081B2 72 10 53 08      [ 1]    1  	bset TIM2_CCER1,#TIM_CCER1_CC1E
      0081B6 72 10 53 00      [ 1]    2 	bset TIM2_CR1,#TIM_CR1_CEN
      0081BA 72 10 53 04      [ 1]    3 	bset TIM2_EGR,#TIM_EGR_UG
      00013E                        276     _led_on 
      0081BE 72 17 50 0A      [ 1]    1     bres ALARM_LED_ODR,#ALARM_LED_BIT 
      0081C2 AE 00 0A         [ 2]  277     ldw x,#10 
      0081C5 CD 82 1F         [ 4]  278     call pause 
      000148                        279     _led_off 
      0081C8 72 16 50 0A      [ 1]    1     bset ALARM_LED_ODR,#ALARM_LED_BIT 
...
Hexadecimal [24-Bits]
      ...
      0081CC 72 11 53 08      [ 1]    1 	bres TIM2_CCER1,#TIM_CCER1_CC1E
      0081D0 72 11 53 00      [ 1]    2 	bres TIM2_CR1,#TIM_CR1_CEN 
      0081D4 81               [ 4]  281     ret 
                                    282 
                                    283 ;--------------------
                                    284 ;  sample detector 
                                    285 ;--------------------
      0081D5                        286 sample:
      0081D5 CD 82 04         [ 4]  287     call flush_cap 
      0081D8 CD 81 F5         [ 4]  288     call charge_cap 
      0081DB CD 81 DF         [ 4]  289     call adc_read  
      0081DE 81               [ 4]  290     ret 
                                    291 
                                    292 
                                    293 ;------------------------
                                    ...
                                    297 ;-------------------------
      0081DF                        298 adc_read:
      0081DF 35 03 54 00      [ 1]  299     mov ADC_CSR,#ADC_INPUT 
      0081E3 72 10 54 01      [ 1]  300     bset ADC_CR1,#0
      0081E7 72 0F 54 00 FB   [ 2]  301     btjf ADC_CSR,#ADC_CSR_EOC,. 
      0081EC C6 54 05         [ 1]  302     ld a,ADC_DRL 
      0081EF 97               [ 1]  303     ld xl,a 
      0081F0 C6 54 04         [ 1]  304     ld a,ADC_DRH 
      0081F3 95               [ 1]  305     ld xh,a 
      0081F4 81               [ 4]  306     ret 
                                    307 
                                    308 ;------------------------
                                    ...
                                    310 ; capacitor 
                                    311 ;------------------------
      0081F5                        312 charge_cap:
      0081F5 72 1E 52 6D      [ 1]  313 	bset TIM1_BKR,#7 ; enable PWM output   
      0081F9 AE 00 09         [ 2]  314     ldw x,#9
      0081FC CD 82 1F         [ 4]  315     call pause 
      0081FF 72 1F 52 6D      [ 1]  316 	bres TIM1_BKR,#7 ; disable PWM output       
      008203 81               [ 4]  317     ret 
                                    318 
                                    319 ;------------------------
                                    ...
                                    322 ;  pin PB3 
                                    323 ;------------------------
      008204                        324 flush_cap: 
      008204 72 11 54 01      [ 1]  325     bres ADC_CR1,#ADC_CR1_ADON
      008208 72 16 50 07      [ 1]  326     bset PB_DDR,#3 
      00820C 72 17 50 05      [ 1]  327     bres PB_ODR,#3 
      008210 AE 00 01         [ 2]  328     ldw x,#1 
      008213 CD 82 1F         [ 4]  329     call pause 
      008216 72 17 50 07      [ 1]  330     bres PB_DDR,#3 
      00821A 72 10 54 01      [ 1]  331     bset ADC_CR1,#ADC_CR1_ADON 
      00821E 81               [ 4]  332     ret 
                                    333 
...
Hexadecimal [24-Bits]
                                    ...
                                    338 ;------------------------
      00821F                        339 pause:
      00821F CF 00 04         [ 2]  340     ldw CNTDWN,x 
      008222 8F               [10]  341 1$: wfi 
      008223 CE 00 04         [ 2]  342     ldw x,CNTDWN 
      008226 26 FA            [ 1]  343     jrne 1$ 
      008228 81               [ 4]  344     ret 
                                    345 
                           000000   346 .if 0
                                    347 ;--------------------------
...
Hexadecimal [24-Bits]
      ...
      008229 72 16 50 C7      [ 1]   35 	bset UART_CLK_PCKENR,#UART_CLK_PCKENR_UART 	
      00822D                         36 uart_set_baud:: 
      00822D 88               [ 1]   37 	push a 
      00822E 72 11 52 44      [ 1]   38 	bres UART_CR1,#UART_CR1_PIEN
                                     39 ; baud rate 115200 : Fmaster/115200
      008232 AE 00 68         [ 2]   40 	ldw x,#FMSTR/115200
      008235 A6 10            [ 1]   41     ld a,#16 
      008237 62               [ 2]   42     div x,a 
      008238 6B 01            [ 1]   43     ld (1,sp),a 
      00823A 9E               [ 1]   44     ld a,xh 
      00823B 1B 01            [ 1]   45     add a,(1,sp)
      00823D C7 52 43         [ 1]   46     ld UART_BRR2,a ; must be loaded first
      008240 9F               [ 1]   47 	ld a,xl 
      008241 C7 52 42         [ 1]   48     ld UART_BRR1,a 
      008244 72 5F 52 41      [ 1]   49     clr UART_DR
      008248 35 0C 52 45      [ 1]   50 	mov UART_CR2,#((1<<UART_CR2_TEN)|(1<<UART_CR2_REN))
      00824C 72 10 52 45      [ 1]   51 	bset UART_CR2,#UART_CR2_SBK
      008250 72 0D 52 40 FB   [ 2]   52     btjf UART_SR,#UART_SR_TC,.
      008255 84               [ 1]   53 	pop a 
      008256 81               [ 4]   54 	ret
                                     55 
...
Hexadecimal [24-Bits]
                                     ...
                                     60 ;---------------------------
      008257                         61 uart_putc:: 
      008257 72 0F 52 40 FB   [ 2]   62     btjf UART_SR,#UART_SR_TXE,.
      00825C C7 52 41         [ 1]   63     ld UART_DR,a 
      00825F 81               [ 4]   64     ret 
                                     65 
                                     66 ;--------------------------
                                     ...
                                     69 ;   A    0| char 
      008260                         70 uart_getc::
      008260 4F               [ 1]   71     clr a 
      008261 72 0B 52 40 03   [ 2]   72     btjf UART_SR,#UART_SR_RXNE,9$
      008266 C6 52 41         [ 1]   73     ld a,UART_DR 
      008269                         74 9$:
      008269 81               [ 4]   75     ret 
                                     76 
                                     77 ;------------------
                                     ...
                                     81 ;    A   char 
                                     82 ;--------------------
      00826A                         83 uart_wait_char:
      00826A CD 82 60         [ 4]   84     call uart_getc 
      00826D 4D               [ 1]   85     tnz a 
      00826E 27 FA            [ 1]   86     jreq uart_wait_char  
      008270 81               [ 4]   87     ret
                                     88 
                                     89 ;-------------------------
                                     ...
                                     93 ;-------------------------
      008271                         94 uart_puts:: 
      008271 F6               [ 1]   95     ld a,(x)
      008272 27 06            [ 1]   96     jreq 9$
      008274 CD 82 57         [ 4]   97     call uart_putc 
      008277 5C               [ 1]   98     incw x 
      008278 20 F7            [ 2]   99     jra uart_puts 
      00827A 72 0D 52 40 FB   [ 2]  100 9$: btjf UART_SR,#UART_SR_TC,9$    
      00827F 81               [ 4]  101     ret 
                                    102 
                                    103 ;---------------
                                    104 ; print integer 
                                    ...
                                    106 ;   X   integer 
                                    107 ;---------------
      008280                        108 uart_prt_int:
      008280 88               [ 1]  109     push a
      008281 90 89            [ 2]  110     pushw y 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 34.
Hexadecimal [24-Bits]



      008283 90 5F            [ 1]  111     clrw y 
      008285                        112 1$:
      008285 A3 00 00         [ 2]  113     cpw x,#0
      008288 27 0A            [ 1]  114     jreq 4$ 
      00828A A6 0A            [ 1]  115     ld a,#10
      00828C 62               [ 2]  116     div x,a 
      00828D AB 30            [ 1]  117     add a,#'0 
      00828F 88               [ 1]  118     push a 
      008290 90 5C            [ 1]  119     incw y 
      008292 20 F1            [ 2]  120     jra 1$ 
      008294 90 5D            [ 2]  121 4$: tnzw y 
      008296 27 0A            [ 1]  122     jreq 7$
      008298 84               [ 1]  123 6$: pop a 
      008299 CD 82 57         [ 4]  124     call uart_putc 
      00829C 90 5A            [ 2]  125     decw y 
      00829E 26 F8            [ 1]  126     jrne 6$
      0082A0 20 05            [ 2]  127     jra 8$ 
      0082A2 A6 30            [ 1]  128 7$: ld a,#'0
      0082A4 CD 82 57         [ 4]  129     call uart_putc 
      0082A7                        130 8$:
      0082A7 A6 20            [ 1]  131     ld a,#32 
      0082A9 CD 82 57         [ 4]  132     call uart_putc 
      0082AC 72 0D 52 40 FB   [ 2]  133     btjf UART_SR,#UART_SR_TC,.
      0082B1 90 85            [ 2]  134     popw y 
      0082B3 84               [ 1]  135     pop a 
      0082B4 81               [ 4]  136     ret 
                                    137 
                                    138 .endif ; DEBUG 
